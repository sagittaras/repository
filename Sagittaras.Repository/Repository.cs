...
public abstract class Repository : IRepository
{
    ...
    {
        while (Operations.TryDequeue(out IRepositoryOperation? operation)) operation.Apply();
...
public abstract class Repository<TEntity, TFirstKey, TSecondKey>(DbContext dbContext, IQueryResultFactory queryResultFactory)
    : Repository<TEntity, TFirstKey>(dbContext, queryResultFactory), IRepository<TEntity, TFirstKey, TSecondKey> where TEntity : class
{
    /// <inheritdoc />
